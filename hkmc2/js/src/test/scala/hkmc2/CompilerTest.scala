...
class CompilerTest extends AnyFunSuite:
  ...
  private val paths = new Paths("/std/Prelude.mls", "/std/Runtime.mjs", "/std/Runtime.mls", "/std/Term.mjs", "/std/Block.mjs", "/std/SpecializeHelpers.mjs", "/std/Option.mjs", "/std/ShapeSet.mjs")
